...
/***/ function(module, exports, __webpack_require__) {
	...
	var CopyExample = __webpack_require__(2);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CopyExample = function () {
	  function CopyExample() {
	    _classCallCheck(this, CopyExample);
	  }
	
	  _createClass(CopyExample, null, [{
	    key: 'washExampleHtml',
	    value: function washExampleHtml(html) {
	    ...
	    key: 'copyExampleHtml',
	    value: function copyExampleHtml(example) {
	      var exampleRows = CopyExample.washExampleHtml(example.outerHTML).split(/\n/).filter(function (row) {
	      ...
	      var e = exampleRows.map(function (row, index) {
	        ...
	        var orgIndent = rowLength - newRow.length;
	        if (index > 0) {
	    ...
	    key: 'init',
	    value: function init() {
	      var showExampleContainer = document.querySelector('.show-example-container');
	      var resultView = document.querySelector('#example-code-view');
	      var closeButton = document.querySelector('#close-example-code-view');
	      ...
	      var allExampleContainers = document.querySelectorAll('.examples-container');
	      allExampleContainers.forEach(function (exampleContainer) {
	        ...
	        var exampleCodeContainer = document.createElement('pre');
	        ...
	        var examples = exampleContainer.querySelectorAll('[data-example]');
	        examples.forEach(function (example) {
	          var exampleName = example.getAttribute('data-example');
	
	          example.addEventListener('click', function (event) {
	            event.preventDefault();
	            var exampleHtml = CopyExample.copyExampleHtml(example);
