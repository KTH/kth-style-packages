  ...
  return (
    <Page>
      <h1>Rubriker, brödtext</h1>
        <p>
          Använd rubriker för att ge struktur och mening till längre textinnehåll. Brödtext används för innehållstext. Det finns fyra rubriknivåer samt brödtext (se nedan).
        </p>
        <p>
