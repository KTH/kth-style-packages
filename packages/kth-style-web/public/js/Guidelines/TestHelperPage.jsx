  ...
  return (
    <Page>
      ...
      <Section title="Testa tillgänglighet">
        ...
        <p>
          KTH-Style har ett script som ger möjlighet att automatiskt utvärdera tillgänglihet mot standarden WCAG 2.0 (AA) (se <a href="/style/guidelines/accessability#overgripande_riktlinjer_tillganglighet">övergripande riktlinjerna för tillgänglighet</a>). Du kan köra scriptet med npm genom att köra <kbd>npm run test-accessibility</kbd>. För att detta ska fungera måste KTH-Style vara deployat på localhost:3000.
        </p>
        <p>
