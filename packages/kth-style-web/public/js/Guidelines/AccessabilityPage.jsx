...
export default function DropdownsPage (props) {
  return (
    <Page>
      ...
      <p>
      En del av arbetet med att ta fram tillgängliga komponenter handlade om att titta på färger. Nedan finns tips på hur man arbetar med <a href="#farger_och_tillganglighet">Färger och Tillgänglighet</a>.
      </p>
