    ...
    <Page>
       ...
       <Section title="Vad är KTH Style?">
        ...
        <Section title="KTHs grafiska profil" id="kths_grafiska_profil">
          <p>
            <a href="https://intra.kth.se/administration/kommunikation/grafiskprofil/grafisk-profil-1.450022">KTHs grafiska profil</a> är beslutad av rektor. Profilen omfattar i dagsläget inte webb (men det pågår ett arbete på KTH centralt att webbanpassa profilen). Därför har det funnits ett behov av att anpassa den grafiska profilen. Hit hör val av fonter, färger, hantering av KTH:s logotyp och bruk av profilens särskilda grafiska element.
          </p>
          <p>
